      ...
      <div className={`card card-flush ${className}`}>
        <div className="card-header pt-5">
          <div className="card-title d-flex flex-column">
            <div className="card-title d-flex flex-column">
              <span className="fs-4hx fw-bold text-gray-900 me-2 lh-1 ls-n2">
                {stats}
              </span>
              <span className="text-gray-500 pt-1 fw-semibold fs-4">
                {description}
              </span>
            </div>
          </div>
        ...
        <div className="card-body d-flex flex-column justify-content-end pe-0">
          <span className="fs-4 fw-bolder text-gray-800 d-block mb-2">
            {intl.formatMessage({ id: 'USER.PRODUCTIVE_AGENTS' })}
          </span>
