...
const LongClaimsTableFilterForUnFundedClaims: FC<ClaimFilterOptions> = ({status_id = null, institution_id = null, user_id = null, canMakeFilter, canExportClaim = false, canImportClaim = false, canAddClaim = false }) => {
  ...
  const resetFilter = async () => {
    ...
    setTimeout(async () => {
      await claimRequest
        .getUnFundedClaimsFilteredListByAllOptions(null, null, institution_id, null, null, null, null, statusId, ref, null, null, null, page, rowsPerPageSize, client_name_or_client_email)
        .then((response: any) => {
  ...
  const makeFilter = async () => {
    ...
    await claimRequest
      .getUnFundedClaimsFilteredListByAllOptions(responseChannelId, null, institution_id, null, null, null, null, statusId, ref, satisfactionLevel, startDate, endDate, page, rowsPerPageSize, client_name_or_client_email)
      .then((response: any) => {
        settotalItems(response.data.total);
        setclaimDatas(response.data.items);
        setclaimloader(false);
  ...
  const getClaims = async () => {
    ...
    await claimRequest
      .getUnFundedClaimsFilteredListByAllOptions(null, null, institution_id, null, null, null, null, statusId, null, satisfactionLevel, startDate, endDate, page, rowsPerPageSize, client_name_or_client_email)
      .then((response: any) => {
        settotalItems(response.data.total);
        setclaimDatas(response.data.items);
        setclaimloader(false);
  ...
  const changePages = async (event: any, value: any) => {
    ...
    await claimRequest
      .getUnFundedClaimsFilteredListByAllOptions(null, null, institution_id, null, null, null, null, statusId, null, satisfactionLevel, startDate, endDate, value, rowsPerPageSize, client_name_or_client_email)
      .then((response: any) => {
        settotalItems(response.data.total);
        setclaimDatas(response.data.items);
        setclaimloader(false);
  ...
  const getClaimsFilteredByRef = async (_ref: string) => {
    ...
    await claimRequest
      .getUnFundedClaimsFilteredListByAllOptions(responseChannelId, null, institution_id, null, null, null, null, statusId, _ref, satisfactionLevel, startDate, endDate, page, rowsPerPageSize, client_name_or_client_email)
      .then((response: any) => {
        settotalItems(response.data.total);
        setclaimDatas(response.data.items);
        setclaimloader(false);
  ...
  const getClaimsFilteredByClientNameorEmail = async (_client_name_or_client_email: string) => {
    ...
    await claimRequest
      .getUnFundedClaimsFilteredListByAllOptions(responseChannelId, null, institution_id, null, null, null, null, statusId, ref, satisfactionLevel, startDate, endDate, page, rowsPerPageSize, _client_name_or_client_email)
      .then((response: any) => {
        settotalItems(response.data.total);
        setclaimDatas(response.data.items);
        setclaimloader(false);
...
export { LongClaimsTableFilterForUnFundedClaims };
