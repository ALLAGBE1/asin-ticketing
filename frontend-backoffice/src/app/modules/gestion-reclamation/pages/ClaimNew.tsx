...
const ClaimNew = () => {
  ...
  const [claimShema, setClaimShema] = useState([
    ...
    Yup.object().shape({
      reception_channel_id: Yup.number().required(
        'Canal de reception requis',
      ),
      response_channel_id: Yup.number().required(
        'Canal de réponse requis',
      ),
  ...
  const [currentSchema, setCurrentSchema] = useState<Yup.AnyObject>(claimShema[0]);
  ...
  const submitStep = (values: ClaimModel, actions: FormikValues) => {
    ...
    if (stepper.currentStepIndex < stepper.totalStepsNumber && stepper.currentStepIndex != 4) {
      stepper.goNext();
      ...
      (stepper.currentStepIndex == 4 && moreDatas.isNewUser && moreDatas.customer_id) ||
      (stepper.currentStepIndex == 4 && moreDatas.isNewUser == '1' && currentSchema.isValid)) {
      stepper.goNext();
    }
    else {
      setClaim(values);
            ...
            <div className="modal-content">
              ...
              <div className="modal-body">
                <div className="fv-row mb-8">
                  ...
                  >
                    <option>
                      {intl.formatMessage({ id: 'CLAIM.CHOOSE_CLAIM_STATUS' })}
                    </option>
                ...
                <div data-kt-stepper-element="content">
                  {(stepper?.currentStepIndex == 5 ) && (
                    <NewClaimStep5ProofsDatas
                      ...
                      savedFilesToUpload={moreDatas?.proofsFilesToUploadList}
