...
import { Team, QueryApiResponse } from "../../../pages/dashboards/demo1/light-sidebar/blocks/teams/teams-types";
import axios from "axios";
import { formatIsoDate } from "@/utils/Date";
import { TeamUsers } from "../../../pages/dashboards/demo1/light-sidebar/blocks/teams/TeamUsers";
  ...
  const Toolbar = ({ setSearchQuery }: { setSearchQuery: (query: string) => void }) => {
    ...
    return (
      <div className="card-header border-b-0 px-5">
        ...
        <div className="input input-md max-w-60">
        ...
        <div className="input input-md max-w-60">
          {/* <KeenIcon icon="magnifier" /> */}
          <select name="" id="">
            <option value="0" selected>Bus</option>
            <option value="1">Mini Van</option>
            <option value="2">Ticycle</option>
          </select>
        </div>
      </div>
    );
