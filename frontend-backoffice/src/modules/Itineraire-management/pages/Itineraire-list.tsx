...
import { Statistics } from "@/pages/public-profile/profiles/creator";
import {
  Activity,
  FavoriteGames,
  NowPlaying,
...
import { NavbarActions, NavbarDropdown } from "@/partials/navbar";
import { ItineraireItem } from "../components/ItineraireItem";
    ...
    <Fragment>
      <Container>
        <Toolbar>
          <ToolbarHeading
            title="Itinéraires"
            description="Gestion et administration des itinéraires"
          />
          {/* <ToolbarActions>
            <Popover>
          ...
          <NavbarActions>
            <button type="button" className="btn btn-sm btn-primary">
              <KeenIcon icon="route" /> Nouvel Itinéraire
            </button>
