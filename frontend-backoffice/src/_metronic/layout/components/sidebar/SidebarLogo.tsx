...
const SidebarLogo = (props: PropsType) => {
  ...
  return (
    <div className="app-sidebar-logo px-6" id="kt_app_sidebar_logo">
      <Link to="/dashboard" className="m-0-auto d_block">
        {config.layoutType === 'dark-sidebar' ? (
          <>
            <img
              alt="Logo"
              // src={toAbsoluteUrl('media/logos/SATIS.png')}
              src={toAbsoluteUrl('media/ABI_ASSETS/AAVIE_FAV.jpg')}
              className="h-125px app-sidebar-logo-default"
            />
            {/* <span className='text-white app-sidebar-logo-default'>Assurance</span> */}
          </>
        ) : (
          <>
            <img
              alt="Logo"
              src={toAbsoluteUrl('media/ABI_ASSETS/AAVIE_FAV.jpg')}
              className="h-125px app-sidebar-logo-default theme-light-show"
            />
            <img
              alt="Logo"
              src={toAbsoluteUrl('media/ABI_ASSETS/AAVIE_FAV.jpg')}
              className="h-125px app-sidebar-logo-default theme-dark-show"
            />
            {/* <span>Assurance</span> */}
          </>
        )}
