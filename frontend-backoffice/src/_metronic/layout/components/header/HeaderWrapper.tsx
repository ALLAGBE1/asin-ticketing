...
export function HeaderWrapper() {
  ...
  //@ts-ignore
  const [user_datas, setuser_datas] = useState<any>(
    JSON.parse(localStorage.getItem(USER_DATAS_KEY)),
  );
        ...
        >
          {config.app.header.default?.content === 'menu' &&
            config.app.header.default.menu?.display && (
              ...
              >
                <h2
                  className="mt-24 fs-3 btn btn-primary btn-active-primary w-auto"
                  style={{
                    borderRadius: '17px',
                    textAlign: 'left',
                    padding: '8px',
                ...
                >
                  {user_datas?.unity.institution.name} -{' '}
                  {user_datas?.unity.institution.institution_type.libelle}
                </h2>
